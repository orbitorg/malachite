...
use malachite_node::config::{Config as NodeConfig, MempoolConfig, NetworkType, TestConfig};
...
async fn spawn_gossip_consensus_actor(
    ...
    let config_gossip = GossipConsensusConfig {
        ...
        network_type: match cfg.consensus.p2p.network {
            NetworkType::GossipSub => malachite_gossip_consensus::NetworkType::GossipSub,
            NetworkType::Broadcast => malachite_gossip_consensus::NetworkType::Broadcast,
        },
    };
